        ...
        <div className="wrap">
          <div className={styles.featureGrid}>
            ...
            <div className={styles.featureBody}>
              ...
              <h2>Zola, age 11, built an app that maps her grandmother's herbal medicine knowledge.</h2>
              <p>"I wanted Gogo's plants to be somewhere even after she isn't here." What began as a six-week Creator Camp turned into a year-long archive project.</p>
      ...
      <div className={styles.filterBar}>
        <div className={`wrap ${styles.filterWrap}`}>
          <div className={styles.chips}>
            <button className={`${styles.chip} ${styles.active}`}>All Stories</button>
          ...
          <div className={styles.magGrid}>
            <Link href="#" className={`${styles.card} ${styles.span4}`}>
              <div className={styles.img}>
                <ImagePlaceholder tone="warm" photoUrl="https://images.unsplash.com/photo-1571260899304-425eee4c7efc?auto=format&fit=crop&w=800&q=80" />
              </div>
              <div className={styles.meta}><span className={styles.tag}>Parent</span><span>Nairobi</span></div>
              <h3>"He shows me his code now, the way he used to show me drawings."</h3>
            ...
            <Link href="#" className={`${styles.card} ${styles.span4}`}>
              <div className={styles.img}>
                <ImagePlaceholder tone="sage" photoUrl="https://images.unsplash.com/photo-1497486751825-1233686d5d80?auto=format&fit=crop&w=800&q=80" />
              </div>
              <div className={styles.meta}><span className={styles.tag}>School</span><span>Lagos</span></div>
            ...
            <Link href="#" className={`${styles.card} ${styles.span4}`}>
              ...
              <div className={styles.meta}><span className={styles.tag}>Chapter</span><span>Accra</span></div>
              <h3>The Accra chapter officially launches with 40 mentors.</h3>
              <p>Our first expansion into Ghana begins with a week-long mentor training bootcamp.</p>
              <div className={styles.byline}>2 min read</div>
            </Link>

            <Link href="#" className={`${styles.card} ${styles.span8}`}>
              <div className={styles.img}>
                <ImagePlaceholder tone="cool" photoUrl="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=1200&q=80" />
              </div>
              <div className={styles.meta}><span className={styles.tag}>Pedagogy</span><span>Global</span></div>
              <h3>Why we don't teach syntax first.</h3>
              <p>A deep dive into the KiddyKode methodology: why starting with a broken project is better than starting with a perfect "Hello World".</p>
              <div className={styles.byline}>By Adaeze Okonkwo · 8 min read</div>
            </Link>

            <Link href="#" className={`${styles.card} ${styles.span4}`}>
              <div className={styles.img}>
                <ImagePlaceholder tone="clay" photoUrl="https://images.unsplash.com/photo-1588072432836-e10032774350?auto=format&fit=crop&w=800&q=80" />
              </div>
              <div className={styles.meta}><span className={styles.tag}>Project</span><span>Kigali</span></div>
              <h3>The 14-year-old who built a better bus schedule.</h3>
            ...
            <Link href="#" className={`${styles.card} ${styles.span6}`}>
              <div className={styles.img}>
                <ImagePlaceholder tone="warm" photoUrl="https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=800&q=80" />
              </div>
              <div className={styles.cardBody}>
                <div className={styles.meta}><span className={styles.tag}>Impact</span><span>Q1 2026</span></div>
                <h3>The first 10,000 learners.</h3>
                <p>We crossed our first major milestone this month. Here is what we learned, what broke, and how we are adjusting the model for the next 90,000.</p>
            ...
            <Link href="#" className={`${styles.card} ${styles.span6}`}>
              ...
              <div className={styles.cardBody}>
                <div className={styles.meta}><span className={styles.tag}>Platform</span><span>Studio Update</span></div>
                <h3>Introducing offline sync for Studio.</h3>
                <p>How we rebuilt our browser IDE to handle intermittent connectivity without losing a single line of student code.</p>
                <div className={styles.byline}>By Samuel Kamau · 5 min read</div>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="wrap">
          ...
          <div className={styles.seriesGrid}>
            ...
            <Link href="#" className={styles.sCard}>
              ...
              <p>A Year 6 class collaborated to replace their school's paper ledger.</p>
            </Link>
            <Link href="#" className={styles.sCard}>
              <div className={styles.ep}>Episode 03 — Cape Town</div>
              <h4>The load-shedding homework planner.</h4>
              <p>An app that reschedules tasks based on the Eskom power grid API.</p>
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className={styles.submitGrid}>
            <div>
              ...
              <p className="lede mt-[24px]">We rely on chapter leads, mentors, and teachers to surface the best projects and stories from the ground.</p>
              <a href="mailto:press@kiddykode.org" className="btn btn--primary mt-[32px]">Email the Editor <span className="arrow">→</span></a>
            </div>
            <div className={styles.subCard}>
              <div className={styles.stepRow}>
                ...
                <div>
                  <h4>Keep it brief</h4>
                  <p>Send a 3-4 sentence pitch. What was built, who built it, and why does it matter?</p>
                </div>
              </div>
              <div className={styles.stepRow}>
                ...
                <div>
                  <h4>Get consent</h4>
                  <p>If pitching a student story, ensure you have verbal approval from the parents before we begin interviewing.</p>
                </div>
              </div>
              <div className={styles.stepRow}>
                ...
                <div>
                  ...
                  <p>A link to the Studio project or a photo of the demo goes a long way.</p>
                </div>
              </div>
            </div>
          </div>
